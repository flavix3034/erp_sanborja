...
/*use \home\cubilxsp\public_html\erpc\assets\zendframework\zend_barcode\src\Barcode;*/
//use https://cubifact.com/assets/zendframework/zend_barcode/src/Barcode;
...
class Tec_barcode
{
    ...
    public function generate($text, $bcs = 'code128', $height = 50, $drawText = true, $get_be = false) {
        ...
        //$imageResource = $this->Barcode::draw($bcs, 'image', $barcodeOptions, $rendererOptions);
