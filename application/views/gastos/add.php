...
<section class="content">
    ...
    <?php echo form_open_multipart(base_url("gastos/save"), 'onsubmit="return validar_gral()" class="validation" id="form_compra"'); ?>
    <div class="row filitas">
        <div class="col-xs-6 col-sm-5 col-md-4 col-lg-3">
            <label>Fecha</label>
            <input type="datetime-local" name="date" id="date" value="<?= $fecha ?>" class="form-control" required="required">
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function guardar_gasto(){
        console.log("inicia guardar_gasto")
        if(validar_gral()){
