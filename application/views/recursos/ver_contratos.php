                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table id="SLData" class="table table-striped table-bordered table-condensed table-hover" data-page-length='50'>
                            <thead>
                                <tr>
                                    <td colspan="8" class="p0" style="border-style: solid; border-color: black; border-width: 1px;">
                                        <input type="text" class="form-control b0" name="search_table" id="search_table" placeholder="<?= lang('type_hit_enter'); ?>" style="width:100%;">
                                    </td>
                                </tr>

                                <tr class="active">
                                    <!-- // id fec_ini fec_fin activo id_personal nombres apellidos sueldo -->
                                    <th style="max-width:30px;">Id</th>
                                    <th class="col-xs-1 col-sm-1 text-left" style="text-align:left">Fec_inicio</th>
                                    <th class="col-xs-1 col-sm-1 text-left" style="text-align:left">Fec_fin</th>
                                    <th class="col-xs-2 col-sm-2">Activo</th>
                                    <th class="col-sm-2">Id_personal</th>
                                    <th class="col-xs-1 col-sm-1">Nombres</th>
                                    <th class="col-xs-1 col-sm-1">Apellidos</th>
                                    <th class="col-xs-1 col-sm-1">Sueldo</th>
                                    <th style="min-width:75px; max-width:115px; text-align:center;">Actions</th>
                                </tr>
...
<script type="text/javascript">
    function modificar(id){
        window.location.href = "<?= base_url() ?>recursos/agregar_contratos?id=" + id
    }
    ...
    function eliminar(id){
        if(confirm("Confirme que desea eliminar?")){
            $.ajax({
                data : {id:id},
                type : 'get',
                url  : '<?= base_url('recursos/eliminar_contratos') ?>',
    ...
    $(document).ready(function(){
        ...
        var table = $('#SLData').DataTable({
            ...
            'ajax' : { 
                url: '<?= base_url('recursos/get_contratos');?>', 
                type: 'POST', 
                "data": function ( d ) {
