...
<section class="content" style="margin: 15px 0px 10px 20px;">
    ...
    <div class="row" id="grilla">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <table id="tbl_gastos_tipo" class="display" style="font-size: 12px; width: 100%; margin-bottom: 20px;" data-page-length='25'>
                <thead>
                    <tr>
                        <th>Origen</th>
                        <th>Fecha</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#tbl_gastos_tipo').DataTable({
            ...
            "ajax": "<?= base_url("reportes/get_gastos_por_tipo/{$desde}/{$hasta}") ?>",
    ...
    function activo1(){
        ...
        document.getElementById('refresco').innerHTML = '<a href="<?= base_url() ?>reportes/gastos_por_tipo/' + desde + '/' + hasta + '" id="enlace_grilla_gastos_tipo">Ejecutar</a>';
        document.getElementById('preparo').style.display = "none";
        document.getElementById('enlace_grilla_gastos_tipo').click();
    }
</script>
