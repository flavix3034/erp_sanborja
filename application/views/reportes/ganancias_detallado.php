...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "ajax": "<?= base_url("reportes/get_ganancias_detallado/{$desde}/{$hasta}/{$store_id}") ?>",
    ...
    function activo1(){
        ...
        document.getElementById('refresco').innerHTML = '<a href="<?= base_url() ?>reportes/ganancias_detallado/' + desde + '/' + hasta + '/' + store_id + '" id="enlace_grilla_compras">Ejecutar</a>'
