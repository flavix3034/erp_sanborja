...
<section class="content" style="margin-left: 20px; margin-top: 15px;">
    ...
    <div class="row" id="grilla">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-11">
            <table id="example" class="display" style="width:100%; font-size: 12px; margin-bottom: 20px;" data-page-length='12'>
                <thead>
                    <tr>
                        <!-- sale_id, fecha, store_id, tienda, customer_id, nombre_cliente, monto_cuenta -->
                        <th>id</th>
                        <th>Fecha</th>
                        <th>store_id</th>
                        <th>Tienda</th>
    ...
    <!--<a href="#" data-toggle="modal" data-target="#myModal">Opencito</a>-->

    <!-- Modal -->
    <?= form_open_multipart(base_url("cuentas_cobrar/save"), 'class="validation" id="form_compra"'); ?>
    <div class="modal fade" id="myModal" role="dialog">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
          <h4 class="modal-title" id="tit_modal">Amortizaci&oacute;n</h4>
              <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                Fecha:<input type="date" name="date" id="date"><br>
                Monto:<input type="text" name="monto" id="monto">
                <input type="text" name="sale_id" id="sale_id">
                <input type="text" name="tienda_id" id="tienda_id">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "ajax": "<?= base_url("cuentas_cobrar/get_cobrar/{$desde}/{$hasta}/{$store_id}") ?>", // 
            ...
            ,"columnDefs":[
                ...
                //{ "bVisible": false, "aTargets": [0,2,4] } // "id","fecha","store_id","tienda","customer_id","nombre_cliente"
            ]
    ...
    function activo1(){
        ...
        document.getElementById('refresco').innerHTML = '<a href="<?= base_url() ?>cuentas_cobrar/listar/' + desde + '/' + hasta + '/' + store_id + '" id="enlace_grilla_compras">Ejecutar</a>'
    ...
    function saldar(id, store_id, customer_id){
        document.getElementById("sale_id").value = id
        document.getElementById("tienda_id").value = store_id
        document.getElementById("cliente").value = customer_id
        /*const xhttp = new XMLHttpRequest();
        xhttp.onload = function() {
            document.getElementById("monto_saldar").innerHTML = this.responseText;
        }
        xhttp.open("GET", '<?= base_url("cuentas_cobrar/monto_saldar/") ?>'+id, true);
        xhttp.send();*/
    }
